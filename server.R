...
shinyServer(function(input, output, session) {
  ...
  , options = list(lengthMenu = c(10, 15, 30), pageLength =15)
  )
  ...
  output$data_table_for_regression <- DT::renderDataTable(
    t(data_for_regression()[1:10, ]), selection = list(target = 'row'),options = list(lengthMenu = c(10, 15, 30), pageLength =15)
  )
  ...
  output$data_table_for_classification <- DT::renderDataTable(
    t(data_for_classification()[1:10, ]), selection = list(target = 'row'), options = list(lengthMenu = c(10, 15, 30), pageLength =15)
  )
  ...
  output$data_table_for_clustering <- DT::renderDataTable(
    t(data_for_clustering()[1:10, ]), selection = list(target = 'row'), options = list(lengthMenu = c(10, 15, 30), pageLength =15)
  )
